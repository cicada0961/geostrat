...
int main(void) {
    ...
    initialiser_pays(pays, "Arcturia", "Elara Voss", 75, 3200, 90, 1200, 4200.5, 320,
        450, 3500, 800, 120, 0, 2, &taille);
    initialiser_pays(pays, "Kaldera", "Malik Drevon", 42, 8500, 45, 600, 890.0, 95,
        1200, 9000, 400, 350, 1, -1, &taille);
    initialiser_pays(pays, "Veralion", "Seun Adara", 88, 400, 72, 3800, 2100.75, 210,
        280, 1200, 550, 60, 0, 0, &taille);
